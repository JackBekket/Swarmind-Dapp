...
// ProcessResponse is a paid mutator transaction binding the contract method 0x3be93d0b.
//
// Solidity: function ProcessResponse(uint256 request_id, string worker_id, uint256 llm_id, uint256 llmInputTokens, uint256 llmOutputTokens, uint256 processingTime, address user) returns()
func (_Pool *PoolTransactor) ProcessResponse(opts *bind.TransactOpts, request_id *big.Int, worker_id string, llm_id *big.Int, llmInputTokens *big.Int, llmOutputTokens *big.Int, processingTime *big.Int, user common.Address) (*types.Transaction, error) {
	return _Pool.contract.Transact(opts, "ProcessResponse", request_id, worker_id, llm_id, llmInputTokens, llmOutputTokens, processingTime, user)
}

// ProcessResponse is a paid mutator transaction binding the contract method 0x3be93d0b.
//
// Solidity: function ProcessResponse(uint256 request_id, string worker_id, uint256 llm_id, uint256 llmInputTokens, uint256 llmOutputTokens, uint256 processingTime, address user) returns()
func (_Pool *PoolSession) ProcessResponse(request_id *big.Int, worker_id string, llm_id *big.Int, llmInputTokens *big.Int, llmOutputTokens *big.Int, processingTime *big.Int, user common.Address) (*types.Transaction, error) {
	return _Pool.Contract.ProcessResponse(&_Pool.TransactOpts, request_id, worker_id, llm_id, llmInputTokens, llmOutputTokens, processingTime, user)
}

// ProcessResponse is a paid mutator transaction binding the contract method 0x3be93d0b.
//
// Solidity: function ProcessResponse(uint256 request_id, string worker_id, uint256 llm_id, uint256 llmInputTokens, uint256 llmOutputTokens, uint256 processingTime, address user) returns()
func (_Pool *PoolTransactorSession) ProcessResponse(request_id *big.Int, worker_id string, llm_id *big.Int, llmInputTokens *big.Int, llmOutputTokens *big.Int, processingTime *big.Int, user common.Address) (*types.Transaction, error) {
	return _Pool.Contract.ProcessResponse(&_Pool.TransactOpts, request_id, worker_id, llm_id, llmInputTokens, llmOutputTokens, processingTime, user)
}
